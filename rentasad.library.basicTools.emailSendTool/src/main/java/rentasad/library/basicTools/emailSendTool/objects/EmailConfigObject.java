...

{
	...
	public EmailConfigObject(
			String mailserver, String username, String password)
	{
		super();
	 ...
	 * @throws UnknownTableEnumException  Creation: 22.10.2015 by mst
	 ...
	 * Description: E-Mail
	 *
	 * @param fileNameString path to File in Resources
	 ...
	 * @throws ConfigFileToolException
	 */
	public static EmailConfigObject readConfigurationFromResources(final String fileNameString, final String sectionName)
			throws InvalidFileFormatException, FileNotFoundException, IOException, ConfigParserException, UnknownTableEnumException, ConfigFileToolException
	{
		EmailConfigObject emailConfigObject = new EmailConfigObject();
	 ...
	 * @throws UnknownTableEnumException
	 * @throws InvalidFileFormatException
	 * @throws IOException                Creation: 22.10.2015 by mst
	 */
	 ...
	 *
	 * @param propertyValue
	 * @param enumItem      Creation: 22.10.2015 by mst
	 * @throws UnknownTableEnumException
	 */
